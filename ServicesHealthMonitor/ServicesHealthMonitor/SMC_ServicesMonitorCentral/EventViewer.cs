...
namespace SMC_ServicesMonitorCentral
{
    public partial class EventViewer : Form
    {
        ...
        public EventViewer(string machineName, IEnumerable<string> serviceNames, Form parent = null)
        {
            ...
            this.serviceNames.AddLast(Smc.SourceName);
        ...
        /// </summary>
        public void LoadEventLog(bool refreshEvents = true)
        {
            Cursor tempC = Cursor;
            ...
            {
                if (!smcEvent_chkbox.Checked && ele.Source == Smc.SourceName)
                    continue;
        ...
        private void smcEvent_chkbox_CheckedChanged(object sender, EventArgs e)
        {
            LoadEventLog(false);
        }
    }
